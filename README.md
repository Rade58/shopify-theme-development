...
WE RE GOING TO EXECUTE `shopify theme serve` (BUT NOT JUST YET, READ THIS SECTION)
...
IN MY STORE DASBOARD I GAVE A PERMISSION TO THE NEW USER (`Settings` (bottom left) ==>  `Users and permissions` --> `Add Staff`)

**I LOGGED OUT FROM EVERYTHING AND I WENT TO MY STORES URL `https://<store name>.shopify.com/admin` (DONT FORGET SLASH ADMIN)**
...
## WE PULLED OUR THEME IN OUR PROJECT FOLDER

WE HAVE ALL THE FILES

WE CAN COMMIT AND PUSH OUR THEME TO GITHUB
