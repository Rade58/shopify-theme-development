...
# I CAN UE CLI TO PUBLISH THEMES AS WELL
...
AND STILL YOU ARE GOING TO BE PROMPTED TO WHAT THEME YOU WANT TO PUBLISH

**BUT ONLY COPIES (NON DEPLOYED (UNPUBLISHED)) THEMES ARE LISTED**

**IF YOU WANT TO PUBLISH TO DEPLOYED THEME YOU NEED TO SPECIFY `--force` FLAG OR `-f`**